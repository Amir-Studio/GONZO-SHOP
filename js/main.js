// ============================================================
// GONZO SHOP — main.js (نسخه نهایی با خواندن از GitHub)
// ============================================================
...
async function saveAllToServer() {
    ...
    try {
        ...
        // ذخیره در سرور (اگر Worker فعال باشد)
