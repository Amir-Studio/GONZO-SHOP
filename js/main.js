// ============================================================
// GONZO SHOP — main.js (نسخه نهایی با امنیت بهبودیافته)
// ============================================================
...
// ============================================================
// CONFIG — تنظیمات و آدرس Worker
// ============================================================
const API_BASE_URL = 'https://gonzo-admin.kabiri1489.workers.dev';

// ============================================================
// LOAD ACCOUNTS — از GitHub از طریق Worker
// ============================================================
    ...
    try {
        ...
        if (response.ok) {
            ...
            if (result.success && result.data && result.data.length > 0) {
                // فیلتر AK-006 حذف شد تا همه اکانت‌ها نمایش داده شوند
...
function renderAccounts(accounts) {
    ...
    // به‌روزرسانی شمارنده بعد از رندر
    updateAccountCount();
}

// ============================================================
// به‌روزرسانی شمارنده اکانت‌ها (رفع باگ)
// ============================================================
...
// ============================================================
// ADMIN LOGIN — با احراز هویت از طریق Worker
// ============================================================
...
// توکن ادمین (در sessionStorage نگهداری می‌شود)
...
function closeAdminPanel() {
    ...
    document.body.style.overflow = '';
    // بارگذاری مجدد داده‌ها پس از بستن پنل
    (async function() {
        allAccounts = await loadAccounts();
        renderAccounts(allAccounts);
    })();
...
// ============================================================
// ADMIN PANEL — با اتصال به GitHub از طریق Worker
// ============================================================
...
async function saveAllToServer() {
    ...
    try {
        ...
        // اگر خطای احراز هویت بود، توکن را پاک کنیم
...
console.log('✅ GONZO SHOP loaded. اتصال به GitHub از طریق Worker فعال است.');