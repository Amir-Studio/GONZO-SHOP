...
const adminGuide = document.getElementById('adminIdInGuide');
...
function renderPaymentInfo() {
    ...
    cardDisplay.textContent = CONFIG.cardNumber;
    adminDisplay.textContent = CONFIG.adminSoroushId;
    if (adminGuide) adminGuide.textContent = CONFIG.adminSoroushId;
}
...
copyCardBtn.addEventListener('click', function() {
    copyToClipboard(CONFIG.cardNumber, this);
});

copyAdminBtn.addEventListener('click', function() {
    copyToClipboard(CONFIG.adminSoroushId, this);
});
